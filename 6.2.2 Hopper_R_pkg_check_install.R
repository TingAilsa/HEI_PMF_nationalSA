...
.libPaths(c("/projects/HAQ_LAB/tzhang/pmf_no_gui/R_pkg_check/R/libs", .libPaths()))


# List of libraries to check and install if missing
required_libraries <- c("sf", "data.table", "raster", "gbm", "caret", "lubridate", "dplyr", "plyr", "base", "ggplot2", "USAboundaries", "terra", "ncdf4", "fst", "lubridate", "grdiExtra", "scales", "tidyr", "deming", "patchwork", "ggsci", "ggpatern", "readxl", "missForest", "gbm", "caret")
