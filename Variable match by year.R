...
# ###### 6 GridMET data, projectRaster, and combine ######
# 
# # meteo_variables <- 
...
# meteo_var_comm <- 
#   c("tmmx", "tmmn", "rmax", "rmin", # max & min T, RH,
#     "vs", "th", "pr") # vs, wind velocity at 10m; th, wind direction; pr, Precipitation amoun
# 
# gridmet_year = rast("/Users/TingZhang/Dropbox/HEI_PMF_files_Ting/Nation_SA_data/aa_GRIDMET_source_stacked/Common_GRIDMET_2011_stacked.tif")
# 
# gridmet_year = rast("/Users/TingZhang/Dropbox/HEI_PMF_files_Ting/Nation_SA_data/aa_GRIDMET_stacked/bi_2017_stacked.tif")
# head(gridmet_year); dim(gridmet_year)
