...
#SBATCH --output=/scratch/tzhang23/cmaq_sumaiya/var_combined_rds/machine_learning_output/err_out/%x_%A_%a.out # output file
#SBATCH --error=/scratch/tzhang23/cmaq_sumaiya/var_combined_rds/machine_learning_output/err_out/%x_%A_%a.err # error file
...
# run R 
#Rscript GBM_no_unc_sulfate.R
Rscript GBM_no_unc_noCoords_sulfate.R
