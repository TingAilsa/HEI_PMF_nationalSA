...
#SBATCH --job-name= C_site_25times
...
function part3_BS_DISP {
  echo "Execute BS & DISP"
    ...
    Rscript ${ShR_SCRIPT_DIR}/minQ_Task_numoldsol.R ${dataset}_noCsub_${extremeMethod}_C_${Site_serial}_F_${Factor_number}_base.txt ${Site_serial} ${Factor_number} ${BASE_SCRIPT_DIR}
