...
# model_input_ini = plyr::rename(model_input_ini, 
#                                c("PM25_TOT_DUST" = "PM25_TOT_ARS"))
# model_input_all_grid = plyr::rename(model_input_all_grid, 
#                                c("PM25_TOT_DUST" = "PM25_TOT_ARS"))
...
summary(model_input_use); summary(model_input_all_grid_noPMF)
