...
#SBATCH --array=1-6250  # 125 days × 50 iterations = 6250
...
CMAQ_PERIOD="2017-01_2017-12"  # Change for different periods
...
# Run R script
Rscript ML_holdout_daily_prediction.R "${SLURM_ARRAY_TASK_ID}" "${SOURCE_TEST}" "${CMAQ_PERIOD}"