...
#SBATCH --job-name=Hold_comb

#SBATCH --nodes=1  # number of nodes
#SBATCH --tasks-per-node=1  # tasks per node # up to 128;
##SBATCH --mem-per-cpu=270G  # memory per CORE
#SBATCH --cpus-per-task=4
#SBATCH --mem=150G  # memory per CORE
...
#SBATCH --array=1-16  # 4 sources × N years
##SBATCH --array=2,4 # select certain array to run
...
declare -a periods=("2012-01_2012-12" "2013-01_2012-12" "2015-01_2015-12" "2016-01_2016-12" "2017-01_2017-12")
...
# Run R script
Rscript ML_combine_holdout_daily.R "${current_source}" "${current_period}" # "${current_iteration}"
