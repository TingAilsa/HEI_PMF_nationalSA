...
train_test_dir = paste0(source.test, "/", cmaq_year)
train_test_pred_pattern = 
  paste0("RF_predictions_", source.test, "_", cmaq_period, "_iteration_\\d+\\.fst$")
...
pred_perform_pattern = 
  paste0("RF_var_imp_", source.test, "_", cmaq_period, "_iteration_\\d+\\.fst$")
pred_perform_files <-
  list.files(train_test_dir,
...
write_fst(combined_train_test,
          paste0(combine_path,
                 "RF_Pred_HD_US_01_grids_noUnc_noCoords_train_test_", 
                 source.test, "_", cmaq_period, ".fst"))

write_fst(combined_pred_perform,
          paste0(combine_path,
                 "RF_Pred_HD_US_01_grids_noUnc_noCoords_predictor_perform_", 
                 source.test, "_", cmaq_period, ".fst"))
