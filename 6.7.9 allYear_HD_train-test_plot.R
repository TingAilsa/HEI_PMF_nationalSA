...
#### Annual Comparison: Predictions ####
bb <-
  read.fst("RF_Pred_HD_US_01_predictor_perform_Biomass_2011-2020.fst")
...
head(tt_all); dim(tt_all); class(tt_all)
setDT(tt_all)
# summary(tt_all)
...
ggsave(
  file.path(paste0(used_model, "_Pred_HD_US_01_grids_noUnc_",
                   data_coords, cmaq_year, "_train_test_Metrics.png")), 
  plot = tt_sum_plot, width = 13, height = 9)
