...
write_fst(gbm_all_predictions_coords,
          paste0("GBM_overall_prediction_SiteID_", source.test, "_", cmaq_period, "no_GPS.fst"))
write_fst(gbm_with_pmf_predictions,
          paste0("GBM_prediction_SiteID_with_Uncertainty_", source.test, "_", cmaq_period, "no_GPS.fst"))
