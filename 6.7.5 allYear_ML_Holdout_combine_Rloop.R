...
filter_data_by_year <- function(data, time_period) {
  if(time_period == "2011-2015") {
    return(data[Date <= as.Date("2015-12-31")])   
  } else {
    return(data[Date >= as.Date("2016-01-01")])  
  }
}
...
sources = c("Traffic", "Dust", "Biomass") #"Sulfate", , "Nitrate"
cmaq_year = "2011-2020"
iteration_groups = 1:2
time_periods = c("2011-2015", "2016-2020")

# source.test = "Traffic"; cmaq_year = "2013-01_2013-12"
cmaq_year = "2011-2020"
# source.test = "Sulfate"; iteration_group = 2; time_period = "2011-2015"

for(source.test in sources){ 
  for(time_period in time_periods) { 
    for(iteration_group in iteration_groups){ 
